...
MODULES = {
    ...
    "economy": {
        "emoji": E_COIN,
        "label": "Економіка",
        "desc": "Заробіток, гемблінг, квести та магазин.",
        "commands": [
            ("`/economy`", "Гаманець: банк, переказ, пограбування."),
            ("`/daily`", "Щоденна нагорода + серія днів."),
            ("`/work`", "Легка або складна робота."),
            ("`/crime`", "Спроба злочину — ризик і куш."),
            ("`/shop`", "Магазин: щити, бусти, лутбокси."),
